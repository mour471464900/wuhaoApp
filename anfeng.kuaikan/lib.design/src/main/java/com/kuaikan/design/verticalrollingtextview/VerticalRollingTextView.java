package com.kuaikan.design.verticalrollingtextview;
...
public class VerticalRollingTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, left, mCurrentOffsetY, mPaint);
        canvas.drawText(text2, left, mCurrentOffsetY + mOffset + mTextTopToAscentOffset, mPaint);
    }
    ...
    public void startAnimation(InternalAnimation animation) {
        animation.start();
    }
    ...
    class InternalAnimation {
        ...
        public void updateValue(float startValue, final float endValue) {
            if (animator != null) {
                cancel();
            }
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    mCurrentOffsetY = (float) animation.getAnimatedValue();
                    postInvalidate();
