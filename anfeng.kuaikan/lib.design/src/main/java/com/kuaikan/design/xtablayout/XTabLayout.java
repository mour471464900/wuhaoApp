package com.kuaikan.design.xtablayout;
...
import com.anfeng.lib.design.R;
...
public class XTabLayout extends HorizontalScrollView {
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        mTabStrip.setmSelectedIndicatorRound(
                a.getDimensionPixelSize(R.styleable.XTabLayout_xTabIndicatorRound, 0));
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mSelectedIndicatorRound;
        ...
        void setmSelectedIndicatorRound(int width) {
            if (mSelectedIndicatorRound != width) {
                mSelectedIndicatorRound = width;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                canvas.drawRoundRect(rectf, mSelectedIndicatorRound, mSelectedIndicatorRound, mSelectedIndicatorPaint);
            }
        }
    }
