...
import com.anfeng.wuhao.anfengkuaikan.ui.fragment.MainFragment;
...
import com.anfeng.wuhao.anfengkuaikan.ui.view.AppViewPage;
...
//           ，动态1      ,动态2,         动态3,       动态4,      动态5    ，昨天   今天
    ...
    public void requestData() {
        HttpHelper.getInstance().httpGetString(URLCommon.URL_BANNER, DataActivity.this, new RequestCallback<String>() {
