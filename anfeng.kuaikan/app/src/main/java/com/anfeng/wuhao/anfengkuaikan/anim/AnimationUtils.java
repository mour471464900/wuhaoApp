...
import com.anfeng.wuhao.anfengkuaikan.task.Task;
...
//	}
	...
	private static Drawable getChildViewDrawable(final View view) {
		...
		if (view instanceof TextView) {
			 ...
			 * else { drawable = view.getBackground(); }
			 */
		return drawable;
	}
...
//		AnimValue<Integer> animValue = new AnimValue<Integer>(value);
