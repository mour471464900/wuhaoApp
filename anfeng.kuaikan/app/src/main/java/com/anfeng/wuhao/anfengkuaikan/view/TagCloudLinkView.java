...
public class TagCloudLinkView extends RelativeLayout
{
    ...
    private static final int TAG_LAYOUT_TOP_MERGIN = 40;
    private static final int TAG_LAYOUT_LEFT_MERGIN = 40;
    private static final int INNER_VIEW_PADDING = 50;
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle)
    {
        ...
        mTagLayoutColor = typeArray.getColor(R.styleable.TagCloudLinkView_tagLayoutColor, DEFAULT_TAG_LAYOUT_COLOR);
        ...
        mDeletableTextColor = typeArray.getColor(R.styleable.TagCloudLinkView_deletableTextColor, DEFAULT_TAG_TEXT_COLOR);
        mDeletableTextSize = typeArray.getDimension(R.styleable.TagCloudLinkView_deletableTextSize, DEFAULT_DELETABLE_TEXT_COLOR);
    }
    ...
    public void drawTags()
    {
        ...
        for (Tag item : mTags)
        {
            ...
            // TODO: 2017/8/15 重写这个方法就可以改变文字的背景
            tagLayout.setBackgroundResource(R.drawable.shape_find_tag); 
//            tagLayout.setBackgroundColor(mTagLayoutColor);
            ...
            tagView.setPadding(INNER_VIEW_PADDING, 30, INNER_VIEW_PADDING, 30);
